...
//            if(passEleVetonew && phosc_eta>1.566 && phosc_eta<2.5 && (*photons)[ip].hadTowOverEm()<0.0219 && chiso<10 && nhiso<(1.715 + (0.0163*(*photons)[ip].pt()+0.000014*(*photons)[ip].pt()*(*photons)[ip].pt()))  && phoiso<(3.863+0.0034*(*photons)[ip].pt()) && !(photon_sieie[ip]<0.03001 && chiso<4)) {ismedium_photon_f=1;}
            ...
            if(fabs(phosc_eta)<1.4442 && !((*photons)[ip].hadTowOverEm()<0.0597 && photon_sieie[ip]<0.01031 && chiso<1.295 && nhiso<(10.91 + (0.0148*(*photons)[ip].pt()+0.000017*(*photons)[ip].pt()*(*photons)[ip].pt())) && phoiso<(3.63+0.0047*(*photons)[ip].pt()))){ismedium_photon_f=1;}
            if(fabs(phosc_eta)>1.566 && fabs(phosc_eta)<2.5  && !((*photons)[ip].hadTowOverEm()<0.0481 && photon_sieie[ip]<0.03013 && chiso<1.011 && nhiso<(5.931 + (0.0163*(*photons)[ip].pt()+0.000014*(*photons)[ip].pt()*(*photons)[ip].pt())) && phoiso<(6.641+0.0034*(*photons)[ip].pt()))){ismedium_photon_f=1;}
